...
const DoctorPassword = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
     ...
     const response=await fetch(`${api}/api/forget/get/otp/toVerify`,
      {
        method:"POST",
        credentials:"include",
        headers:{
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
     ...
     const response=await fetch(`${api}/api/forget/post/Otp`,
      {
        method:"POST",
        credentials:"include",
        headers:{
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      const response=await fetch(`${api}/api/forget/change/password`,
      {
        method:"POST",
        credentials:"include",
        headers:{
