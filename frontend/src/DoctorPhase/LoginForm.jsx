...
const LoginForm = () => {
  ...
  async function credentialsChecking(e) {
    ...
    try {
      const response = await fetch(`${api}/api/doctors/DoctorLogin`, {
        method: "POST",
        credentials: "include",
        headers: {
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 px-12 text-white max-w-lg space-y-4">
          ...
          <p className="text-slate-300 text-sm leading-relaxed">
            Manage your appointments, patient consultations, and clinical earnings securely in one unified dashboard.
          </p>
        </div>
      </div>
